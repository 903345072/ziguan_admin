<template>
  <div class="app-container">
    ...
    >
      <el-table-column :label="$t('table.id')" prop="id" align="center" width="70px">
      ...
      <el-table-column :label="$t('order.dl_name')" prop="make_order_date" width="120px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.member.p_admin.username }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('order.contract_no')" prop="make_order_date" width="120px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('order.stock_name')" width="120px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.actions')" align="center" min-width="120" class-name="small-padding fixed-width">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        <el-form-item label="持仓手数" prop="buy_hand" :rules="[{ required: true, message: '请输入持仓手数', trigger: 'blur' }]">
          <el-input v-model="temp.buy_hand" />
        </el-form-item>
      </el-form>
...
<script>
import { fetchList, updateRechargeState, updateMemberOrder } from '@/api/order'
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          updateMemberOrder(tempData).then(() => {
